...
def generate_robot_nodes(context):
    ...
    nodes = []
    launch_arguments = {
        'arm_id': str(robot_config['arm_id']),
        'arm_prefix': str(robot_config['arm_prefix']),
        'namespace': str(robot_config['namespace']),
    ...
    for sensor_key, sensor_config in configs['sensors'].items():
    ...
    return LaunchDescription([
        DeclareLaunchArgument(
            ...
            default_value=PathJoinSubstitution([
                FindPackageShare('gentact_ros_tools'), 'config', 'control_test.yaml'
            ]),
